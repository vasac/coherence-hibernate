...
|*4.0.x*             | `17`, `21`, `25` | `15.1.1-0-2` (default), `25.03.1` (compatibility tested) | `7.4.x`       | ✔       | `main`
...
|*{main-snapshot-version}* | `17`, `21`, `25` | `15.1.1-0-2` (default), `25.03.1` (compatibility tested) | ✅       | `main`
